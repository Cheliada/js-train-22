...
class RoleProcessor extends AuthProcessor {
  ...
  validate(username, passkey) {
      ...
      if (username === "guest") {
          ...
          console.log("Вхід дозволено з роллю гостяю");
          return true;
      } else {
